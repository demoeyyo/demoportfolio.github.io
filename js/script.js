$(function() {
    ...
    $('.contact-form').submit(function() {
        ...
        $.ajax({
            ...
            error: function(a, b) {
                if (b == 'error') {
                    $('#result-message').addClass('alert alert-success').html('<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Successful!</strong> Message Send. We will contact with you soon. <br> Send a mail demoictworld@gmail.com for quick response. Thank You!').delay(500).slideDown(500).delay(10000).slideUp('slow');
                };
                $btn.button('reset');
            }
        });
